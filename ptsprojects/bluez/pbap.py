...
def set_pixits(pts):
    ...
    # pts.set_pixit("GAP", "TSPX_secure_simple_pairing_pass_key_confirmation", "FALSE")
    ...
    # pts.set_pixit("GAP", "TSPX_iut_device_IRK_for_resolvable_privacy_address_generation_procedure", "00000000000000000000000000000000")
    # pts.set_pixit("GAP", "TSPX_tester_device_IRK_for_resolvable_privacy_address_generation_procedure", "0123456789ABCDEF0123456789ABCDEF")
    # pts.set_pixit("GAP", "TSPX_iut_device_name_in_adv_packet_for_random_address", iut_device_name)
